		...
		<nav class="navbar navbar-expand-lg bg-body-tertiary"
			...
			<div class="container-fluid">
				...
				<div class="block-logoBookStore">
					<a class="navbar-brand text-black p-1 fs-2" href="./home.jsp"> <img
			...
			<form class="d-flex" role="search">
				<div class="input-group ">
					...
					<button class="btn btn-outline-success" type="button"
						id="button-addon2">
						<img id="image-logo-search" alt="" src="./img/search.png" />
					</button>
				</div>
				
				<a class="btn btn-success p-2"
					style="white-space: nowrap; margin: 0px 5px 0px 10px" href="#">
					<img id="img_giohang" alt="" src="./img/shopping-cart.png" />
				</a>
				...
				<div class="btn-group dropstart ">
					<a type="button" class="btn btn-outline-success dropdown-toggle p-2"
						...
						<img id="img_user" alt="" src="./img/user.png" />
					</a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="customer_view/info-user.jsp">Tài khoản</a></li>
						<li><a class="dropdown-item" href="customer_view/order.jsp">Đơn hàng</a></li>
						<li><a class="dropdown-item" href="customer_view/introduce.jsp">Giới
								thiệu</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="./customer-controller?event=Logout">Đăng Xuất</a></li>
					</ul>
